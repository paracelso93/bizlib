...
namespace biz {
    ...
    void ColorRect::calculate_vertices(Vertex vertices[4]) {
        ...
        vertices[0] = {glm::vec3(f_x1, f_y2, 0.f), glm::vec3(c.r, c.g, c.b), glm::vec2(0.f, 0.f)};
        vertices[1] = {glm::vec3(f_x1, f_y1, 0.f), glm::vec3(c.r, c.g, c.b), glm::vec2(0.f, 0.f)};
        vertices[2] = {glm::vec3(f_x2, f_y1, 0.f), glm::vec3(c.r, c.g, c.b), glm::vec2(0.f, 0.f)};
        vertices[3] = {glm::vec3(f_x2, f_y2, 0.f), glm::vec3(c.r, c.g, c.b), glm::vec2(0.f, 0.f)};
